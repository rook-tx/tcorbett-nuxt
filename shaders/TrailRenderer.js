...
export const TrailRenderer = function( scene, orientToMovement ) {
...
TrailRenderer.prototype.updateIndexRangesForConnectAndDisconnect = function( connectRange, disconnectRange ) {
	...
	} else if ( connectRange.offset + connectRange.count == disconnectRange.offset ) {
